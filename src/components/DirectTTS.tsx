...
export function DirectTTS({ onGenerate, disabled, isLoading }: DirectTTSProps) {
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="px-5 py-3 rounded-xl bg-sinai-400 text-white font-medium hover:bg-sinai-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:shadow-lg hover:shadow-sinai-400/20 flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
